...
public class ProfileService {
    ...
    public ProfileEntity findOrCreateOAuthUser(String email, String name, String provider) {
        return profileRepository.findByEmail(email)
                .orElseGet(() -> {
                    ProfileEntity newUser = ProfileEntity.builder()
                            .email(email)
    ...
    public Map<String, Object> authenticateOAuthUser(ProfileEntity user) {
